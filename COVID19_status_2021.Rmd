...
```{r echo = FALSE, message = FALSE, warning = FALSE}
 ...
 KK <- as.data.frame(cbind("Date" = Dsf,"Day" = 1:length(Dsf), "Without Knots" = kk0[["mean"]], "Smooth spline" = kk1[["mean"]],  "With Knots" = kk[["mean"]], "Polynomial" = kk10[["mean"]], "Lower ARIMA" = kk2[["lower"]], "Upper ARIMA" = kk2[["upper"]]))
...
lower = min(niz$Case)
 ...
 KK <- as.data.frame(cbind("Date" = Dsf, "Day" = 1:length(Dsf))) 
